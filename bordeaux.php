    ...
    <section id="section_jours" class="bg_orange text-muted">
        <div class="container">
            ...
            <div id="mercredi" class="jours">
                ...
                <div class="bg_beige col-centre">
                    <h2 class="text-couleur text-uppercase text-center">M<br>e<br>r<br>c<br>r<br>e<br>d<br>i</h2>
                </div>
                <div class="col-ext">
                    <img src="">
                </div>
            ...
            <div id="vendredi" class="jours">
                ...
                <div class="bg_beige col-centre">
                    <h2 class="text-couleur text-uppercase text-center">V<br>e<br>n<br>d<br>r<br>e<br>d<br>i</h2>
                </div>
                <div class="col-ext">
                    <img src="">
                </div>
